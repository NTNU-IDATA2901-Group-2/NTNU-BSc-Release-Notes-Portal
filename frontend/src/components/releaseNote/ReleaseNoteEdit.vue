    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-1">
        ...
        <div class="flex flex-col sm:flex-row gap-2 justify-between">
          ...
          <SelectChangeNotes :placeholder="t('title.from')" :disabled = "gitRepository === null" :change-notes="currentGitRepositoryChangeNotes ?? []" v-model="fromChangeNote" />
          <SelectChangeNotes :placeholder="t('title.to')" :disabled = "gitRepository === null" :change-notes="currentGitRepositoryChangeNotes ?? []" v-model="toChangeNote" />
          <Button class="w-45" :disabled = "gitRepository === null" type="button" variant="outline" @click.stop="onChangeNoteRangeChange(gitRepository?.id ?? -1)">{{ t('button.updateRange') }}</Button>
        </div>
      </div>
