...
(5, false, true, 1713393100000, 'Implemented performance improvements that reduce API latency and improve rendering speed for larger release note datasets.', 'v1.2.1'),
...
(8, false, true, 1718386900000, 'Deprecated the old API contract and documented migration steps with transitional guidance for dependent clients.', 'v1.3.1'),
...
(15, false, true, 1730039100000, 'Improved API pagination defaults and edge-case handling to reduce duplicate reads and improve response consistency.', 'v1.6.1'),
...
(21, false, true, 1740026700000, 'Introduced smarter empty-state messages that offer contextual guidance and suggest next actions for editors.', 'v1.8.1'),
...
(27, false, true, 1750014300000, 'Improved dark mode contrast values for readability while maintaining visual consistency across major interface areas.', 'v2.0.1'),
...
(30, false, true, 1755008100000, 'Improved localization support with broader string coverage, fallback handling, and cleaner language switching behavior.', 'v2.1.1'),
...
(34, false, true, 1761666500000, 'Extended table column options with configurable visibility and ordering for more personalized workspace layouts.', 'v2.2.2'),
...
(38, false, true, 1768324900000, 'Improved empty release handling to avoid dead ends and present guided options when no related content exists.', 'v2.4.0'),
