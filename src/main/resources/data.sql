...
/*
release_note (archived boolean, published boolean, created_at bigint, id bigint generated by default as identity, summary varchar(255), tag varchar(255), primary key (id))
*/
